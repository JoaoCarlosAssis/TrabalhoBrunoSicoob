import getBankProofPayment from "@/controller/getBankProofPayment";
...
export function ProofPayment() {
  ...
  const handlesubmit = async (e: FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    try {
      const response = await getBankProofPayment(formData);
  ...
  return (
    <div className="bg-[#0B3D48] min-w-[400px] rounded-md p-6">
      <div>
        <span className="font-bold">Comprovante Pagamento</span>
        <div>
